...
function generateReport(){
    ...
    inputDataMap['aaaBondY']=document.getElementById("aaabondY").value;
    inputDataMap['repoRate']=document.getElementById("reporate").value;
    inputDataMap['peZero']=document.getElementById("zpe").value;
    console.log(inputDataMap);
    var requestBody = generateJsonString(inputDataMap);
    console.log(requestBody);
    var url = stockValuationUrl+'/graham';
...
function showValuationValue(){
    ...
    console.log("Gra: response: "+jsonResonse);
