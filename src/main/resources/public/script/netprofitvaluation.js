...
function createNetProfitDataSet(){
    var yrPrefix = "date";
    var netProfitPrefix = "np";

    var i=1;
    var id1 = yrPrefix+'-'+i;
    var id2 = netProfitPrefix+'-'+i;
    var yrele = document.getElementById(id1);
    var netprofitele = document.getElementById(id2);

    var netprofitMap = new Map();
    while(netprofitele!=null && netprofitele.value!=null){
        var yrStr = yrele.value.replace(" ","-");
        if(yrStr!=""){
            netprofiteleval = netprofitele.value.replace(",","");
            netprofitMap[yrStr] = parseFloat(netprofiteleval);
        }
        i++;
        id1 = yrPrefix+'-'+i;
        id2 = netProfitPrefix+'-'+i;
        yrele = document.getElementById(id1);
        netprofitele = document.getElementById(id2);
    }
    console.log(netprofitMap);
    return netprofitMap;
}
...
function generateReport(){
    ...
    var url = stockValuationUrl+'/netprofitvaluation';
...
function showValuationValue(){
    ...
    console.log("shownetprofitvaluation: response: "+jsonResonse);
    var data = JSON.parse(jsonResonse);
    projectedMap = data.projectionDtoMap;
    console.log(projectedMap)
    document.getElementById("estNp1").innerHTML = projectedMap[1];
    document.getElementById("estNp2").innerHTML = projectedMap[2];
    document.getElementById("estNp3").innerHTML = projectedMap[3];
    document.getElementById("estNp4").innerHTML = projectedMap[4];
    document.getElementById("estNp5").innerHTML = projectedMap[5];
    document.getElementById("estNp6").innerHTML = projectedMap[6];
    document.getElementById("estNp7").innerHTML = projectedMap[7];
    document.getElementById("estNp8").innerHTML = projectedMap[8];
    document.getElementById("estNp9").innerHTML = projectedMap[9];
    document.getElementById("estNp10").innerHTML = projectedMap[10];

    document.getElementById("yr10CAGR").innerHTML = data.profitCAGRGrowth10yrs;
    document.getElementById("yr5CAGR").innerHTML = data.profitCAGRGrowth5yrs;

    document.getElementById("cagrPg").innerHTML = data.profitCAGRGrowth10yrs;
    document.getElementById("estnp").innerHTML = data.estimatedProfit;
    document.getElementById("estmcap").innerHTML = data.estimatedMarketCapital;

    document.getElementById("discap").innerHTML = data.discountedMarketCapital;
    document.getElementById("estmcap").innerHTML = data.estimatedMarketCapital;
    document.getElementById("outshare").innerHTML = data.outstandingShare;
